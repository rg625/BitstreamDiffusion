...
5. Logits: softmax vs score matching & \yes & softmax $\equiv$ BCE (proved); SM vs CE \textbf{negative}\\
\bottomrule
\end{tabular}
\end{center}
...
\section{Task 5 --- Logits: softmax vs score matching \yes}
...
finished and tested; only the experimental setup is at fault.
